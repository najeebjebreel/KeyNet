...
class KeyNet:
    ...
    def train_original_task(self, epochs = None, resume = False):
        ...
        plot_loss_original(train_losses,  test_losses, title = 'Baseline loss', filename = 'cifar10_loss_original_'+self.model_name, save = True)
        plot_accuracy_original(train_accs,  test_accs, title = 'Baseline accuracy', filename = 'cifar10_acc_original_'+self.model_name, save = True)
    ...
    resume = False, dataset = 'combined_fromscratch_cifar10'):
        ...
        title = 'Training from scratch of the combined model', filename = 'cifar10_acc_fromscratch_'+self.model_name, save = True)
